...
automation_alert_email_endpoints = ["sre-dev@example.com"]

enable_scheduler                    = true
scheduler_dry_run                   = true
scheduler_start_schedule_expression = "cron(0 8 ? * MON-FRI *)"
scheduler_stop_schedule_expression  = "cron(0 20 ? * MON-FRI *)"
...
tag_auditor_schedule_expression = "cron(0 7 * * ? *)"
...
acm_expiry_threshold_days               = 45
secret_rotation_threshold_days          = 30

enable_orphan_cleanup                    = true
orphan_cleanup_dry_run                   = true
orphan_cleanup_allow_destructive_actions = false
orphan_cleanup_schedule_expression       = "cron(0 3 * * ? *)"
orphan_cleanup_snapshot_retention_days   = 14
orphan_cleanup_log_group_retention_days  = 14
orphan_cleanup_ecr_image_retention_days  = 14

enable_incident_evidence            = true
incident_evidence_target_group_arns = []
incident_evidence_log_group_names = [
  "/aws/lambda/example-service"
]
...
backup_validation_schedule_expression   = "cron(0 4 ? * SUN *)"
backup_validation_snapshot_max_age_days = 7

enable_ssm_runbooks_automation   = true
ssm_patching_schedule_expression = "cron(0 2 ? * SUN *)"
ssm_runbook_schedule_expression  = "cron(0 3 ? * MON-FRI *)"
...
ssm_runbook_require_manual_approval = false
ssm_runbook_dry_run                 = true
...
sg_remediation_schedule_expression         = "cron(0 9 * * ? *)"
...
finops_report_lookback_days       = 14
